...
#####################################
entity_embeddings = torch.load("./data/Thanh/Thanh_cpu_entity_embeddings.pt")
relation_embeddings = torch.load("./data/Thanh/Thanh_cpu_relation_embeddings.pt")
Corpus_ = torch.load("./data/Thanh/Thanh_cpu_corpus.pt")
